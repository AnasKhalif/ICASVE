                ...
                <div class="col-md-6">
                    <div class="card shadow-sm mb-3">
                        <div class="card-body">
                            ...
                            <hr>
                            <div class="d-flex gap-2">
                                <a href="{{ route('landing.conference-title.edit', $title->id) }}" class="btn btn-primary btn-sm">
                                    <i class="bi bi-pencil-square"></i> Edit
                                </a>

                                <form action="{{ route('landing.conference-title.destroy', $title->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
