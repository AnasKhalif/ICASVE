        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive pt-3 d-flex justify-content-around">
                    ...
                    <a href="{{ route('landing.abouts.index') }}" class="btn btn-md btn-danger">About</a>
                    ...
                    <a href="{{ route('landing.publications-journal.index') }}" class="btn btn-md btn-primary">Publications
                        Journal</a>
                    <a href="{{ route('landing.poster.index') }}" class="btn btn-md btn-primary">Poster</a>
                    <a href="{{ route('landing.contact.index') }}" class="btn btn-md btn-primary">Contact</a>
