...
<div class="container">
    ...
    <form action="{{ route('landing.fullpaper-guidelines.update', $fullpaperGuideline->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
            ...
            @if($fullpaperGuideline->pdf_file)
                <p>File saat ini: <a href="{{ asset('storage/' . $fullpaperGuideline->pdf_file) }}" target="_blank">Download</a></p>
            @endif
        </div>
