    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('landing.reviewer-committee.edit', $committee->id) }}" class="btn btn-warning btn-sm">Edit</a>
                    <form action="{{ route('landing.reviewer-committee.destroy', $committee->id) }}" method="POST" class="d-inline">
                        @csrf
                        @method('DELETE')
