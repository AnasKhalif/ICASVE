            ...
            <div class="card-body">
                ...
                <form action="{{ route('landing.gallery.update', $gallery->id) }}" class="forms-sample" method="POST"
                    ...
                    <div class="form-group">
                        <img src="{{ asset('storage/' . $gallery->image_path) }}" alt="Image" width="100" style="margin-top: 15px">
                    ...
                    <div class="form-group">
                        ...
                        <input type="string" class="form-control @error('year') is-invalid @enderror" name="year" id="year" required  value="{{ $gallery->year }}">
                        @error('year')
