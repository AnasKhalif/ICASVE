            ...
            <div class="col-md-6">
                <form action="{{ route('landing.steering.update', $steering->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control" value="{{ old('name', $steering->name) }}"
                            required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="institution" class="form-control"
                            value="{{ old('institution', $steering->institution) }}" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label fw-bold">Country</label>
                        <input type="text" name="country" class="form-control"
                            value="{{ old('country', $steering->country) }}" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label fw-bold">Year</label>
                        <input type="number" name="year" class="form-control" min="2000" max="{{ date('Y') }}"
                            value="{{ old('year', $steering->year) }}" required>
                    </div>
