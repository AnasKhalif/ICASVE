        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('landing.conferance-program.create') }}" class="btn btn-sm btn-success">New conferance
                        program</a>
                </div>
                            ...
                            @foreach ($programs as $program)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('landing.conferance-program.destroy', $program->id) }}"
