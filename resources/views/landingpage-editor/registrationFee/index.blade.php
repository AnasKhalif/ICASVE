        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('landing.registrationFee.create') }}" class="btn btn-sm btn-success">New Registration
                        Fee</a>
                </div>
                            ...
                            @foreach ($registrationFees as $registrationfee)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('landing.registrationFee.destroy', $registrationfee->id) }}"
