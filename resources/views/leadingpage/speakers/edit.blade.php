                ...
                <form action="{{ route('admin.speakers.update', $speaker->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="role" id="role" class="form-control" required>
                            <option value="keynote_speaker" {{ $speaker->role == 'keynote_speaker' ? 'selected' : '' }}>Keynote Speaker</option>
                            <option value="invited_speaker" {{ $speaker->role == 'invited_speaker' ? 'selected' : '' }}>Invited Speaker</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="mb-2">
                            @if ($speaker->image)
                                <img src="{{ asset('storage/' . $speaker->image) }}" alt="Current Image" style="max-width: 150px; display: block;">
                            @endif
                        </div>
